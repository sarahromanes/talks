...
### `r icon::fa("angle-right", size=1)`  Hui et al. (2017) show that it is optimal to pick $q(\mathbf{u}_i) \sim \mathcal{N}(\boldsymbol{\mu}_i, \boldsymbol{\Sigma}_i)$, leading to the following expression for the variational lower bound for the approximate marginal log likelihood.
